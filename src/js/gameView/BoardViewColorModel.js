...
export const COLORS = [
  ...
  {id:5,  color: 'black', backgroundColor: 'hsl(256, 62%, 76%)'},
  ...
  {id:15, color: 'black', backgroundColor: 'hsl(0, 4%, 68%)'},
  {id:16, color: 'black', backgroundColor: 'hsl(0, 77%, 60%)'},
  {id:17, color: 'black', backgroundColor: 'hsl(249, 100%, 70%)'},
  {id:18, color: 'black', backgroundColor: 'hsl(115, 20%, 60%)'},
  {id:19, color: 'black', backgroundColor: 'hsl(39, 90%, 45%)'},
  {id:20, color: 'black', backgroundColor: 'hsl(300, 78%, 70%)'},
  {id:21, color: 'black', backgroundColor: 'hsl(210, 62%, 54%)'},
  {id:22, color: 'black', backgroundColor: 'hsl(80, 66%, 37%)'},
  {id:23, color: 'black', backgroundColor: 'hsl(210, 13%, 50%)'},
  {id:24, color: 'black', backgroundColor: 'hsl(39, 91%, 57%)'},
  {id:25, color: 'white', backgroundColor: 'hsl(240, 92%, 59%)'},
  {id:26, color: 'white', backgroundColor: 'hsl(271, 76%, 53%)'},
  {id:27, color: 'white', backgroundColor: 'hsl(60, 89%, 22%)'},
  {id:28, color: 'white', backgroundColor: 'hsl(328, 66%, 35%)'},
  {id:29, color: 'white', backgroundColor: 'hsl(25, 76%, 31%)'},
  {id:30, color: 'white', backgroundColor: 'hsl(125, 73%, 20%)'},
  {id:31, color: 'white', backgroundColor: 'hsl(0, 68%, 42%)'},
  {id:32, color: 'white', backgroundColor: 'hsl(220, 89%, 28%)'},
  {id:33, color: 'white', backgroundColor: 'hsl(312, 80%, 42%)'},
  {id:34, color: 'black', backgroundColor: 'white'}
];
